...
public class JunitImage {
    ...
    public void testImage() {
        markImageByText("nbaas区块链专用",
                "/Users/wengcheng/IdeaProjects/MyDemo/j2ee-demo/image-demo/src/main/resources/a.jpg",
                "/Users/wengcheng/IdeaProjects/MyDemo/j2ee-demo/image-demo/src/main/resources/a1.jpg",
                45, new Color(0, 0, 0), "JPG");
    }
     ...
     */
    public static void markImageByText(String logoText,
                                       String srcImgPath,
                                       String newImagePath,
                                       Integer degree,
                                       Color color,
        ...
        try {
            ...
            g.drawImage(srcImg.getScaledInstance(
                    srcImg.getWidth(null),
                    srcImg.getHeight(null),
            ...
            g.drawString(logoText, buffImg.getWidth() / 8, buffImg.getHeight() / 2);
            // 9、释放资源
            g.dispose();
            // 10、生成图片

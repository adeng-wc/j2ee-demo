package com.adeng.designpatterns.structural.proxy.jdk;

import com.adeng.designpatterns.structural.proxy.Dog;
...
public class JDKProxyTest {
    ...
    public static void main(String[] args) throws Exception {
     ...
     /*   Person son = (Person) new JDKProxy().getInstance(new Son());
        ...
        //获取当前类路径
        System.out.println(JDKProxyTest.class.getResource("/").getPath());
    }
}

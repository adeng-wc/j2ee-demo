...
//        private String frozeUserPhone;
//        private String frozeReason;
//        private String frozeInitiator;


        JSONObject jsonObject = new JSONObject();
        jsonObject.put("frozeUserPhone","23");
        jsonObject.put("frozeReason","测试冻结");
        jsonObject.put("frozeInitiator","13291838186");
        datastr = JSONObject.toJSONString(jsonObject);
...
//        String pri_key = "";
        // 公匙加密
//        String pubKeyStr = RSAUtil.encryptByPubKey(datastr,publicKey);
        String pubKeyStr = RSAUtil.encryptByPubKey(datastr,"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCZdw8W14Xt5TvNVA2OO2hOJxRPpeZQSojXwsOyu6tZGO/apne4ZkGMOrW1bxJk+6E4k+RYfHmXhVwrvNqgoMgdqyIa4pWODRvauoYgHYfoA7+vIdCiAf57sDRTxjOVBfLZlOhJ4+ywUMrYiUkvu9Vd6s40KmdY0ILwvawmba2lNwIDAQAB");
        System.out.println("公匙加密结果：\n" + pubKeyStr);
//        System.out.println(MD5Util.md5(pubKeyStr));
        // 私匙解密
        byte[] bytes = RSAUtil.decryptByPriKey(pubKeyStr, "");

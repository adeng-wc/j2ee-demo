...
public class InterfaceEncryptAndDecryptUtil {
    ...
    public static String encrypt(Map<String, String> params, String publicKey) throws Exception {
        ...
        for (String key : keys) {
            ...
            sb.append(key)
                    .append("=")
//                    .append(params.get(key) == null ? "" : Base64.encodeBase64URLSafeString(params.get(key).getBytes()))
...
//            new String(Base64.decodeBase64(split1[1]));
            if (split1.length >= 2) {
//                jsonObject.put(split1[0], Base64.decodeBase64(split1[1]));
